...
def main():
    ...
    model_teacher = resnet.resnet18()

    # 체크포인트 경로
    checkpoint_path = '/workspace/ReActNet_Cifar100_PopBin/pytorch_cifar100/checkpoint/resnet18/Monday_24_March_2025_02h_46m_14s/resnet18-200-regular.pth'
    ...
    val_dataset = datasets.CIFAR100(root=args.data, train=False, download=True, transform=transform_test)
